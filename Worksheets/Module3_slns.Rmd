...
**Excercise** Update the below for-loop from above to store the mean value for each column in the dataset. I've given you most of the code but you will need to store each mean value in the vector mean.code.
